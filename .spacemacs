...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;;                             :weight normal
   ;;                             :width normal)
   dotspacemacs-default-font '("JetBrainsMonoNL Nerd Font Mono Medium"
                               :size 14.0
                               :weight normal
                               :width normal)
